...
const options = {
    configOverwrite: { startWithAudioMuted: true,startWithVideoMuted: true,remoteVideoMenu: {disableKick: true },disableRemoteMute: true,enableWelcomePage: false,prejoinPageEnabled: false},
    interfaceConfigOverwrite: { 
        ...
        TOOLBAR_BUTTONS: ['microphone', 'camera', 'chat', 'raisehand','videoquality', 'feedback', 'stats','tileview', 'videobackgroundblur']
    },
    roomName: "NewraSGTBCourseCode-"+'<?php echo $_SESSION["coursecode"] ?>',
    parentNode: document.querySelector('#meet'),
    userInfo:
    {
        displayName: '<?php echo $_SESSION["registeredusn"]; ?>'
    }
};
